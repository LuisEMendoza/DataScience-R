...
Es importante que no descuidemos la actualidad de estos paquetes. Podemos actualizarlos mediante

``` r
tidyverse_update()
```

Lo cual buscará versiones más recientes y, de haberlas, las instalará en lugar de las anteriores.
